...
async def start_rout(message: types.Message) -> None:
    ...
    if creator_case:
        ...
        await message.answer(f"Hello, Creator\n\n"
                             ...
                             f"To get started, click <b><i>/connect</i></b>👈\n\n"
                             ...
                             f"json with users - <b><i>/get_users</i></b> 👈\n\n"
                             f"json with admins - <b><i>/get_admins</i></b> 👈\n\n"
                             f"json with ban users - <b><i>/get_ban_users</i></b> 👈\n\n"
        ...
        await message.answer(f"Hello, admin\n\n"
                             ...
                             f"To get started, press <b><i>/connect</i></b> 👈\n\n"
                             f"---------- Admin Commands👇----------\n\n"
                             f"Ban the user - <b><i>/ban_user</i></b> 👈\n\n"
                             f"Unban the user - <b><i>/unban_user</i></b> 👈\n\n"
                             f"Get logs - <b><i>/get_logs</i></b> 👈\n\n"
        ...
        await message.answer(f"Hello, I am a <b>clientSSH</b>🤖\n\n"
                             f"Bot for managing the server over SSH 💭"
                             f"\n\nFor help, click <b><i>/help</i></b> 👈\n\n"
                             f"To get started, press <b><i>/connect</i></b>👈"
                             f"\n\n\n<b><i>made by <a href='https://t.me/kolo_id'>kolo</a></i></b>",
                             disable_web_page_preview=True)
